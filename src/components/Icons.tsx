...
export function LaptopIcon({ ...props }: ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      <path
        fillRule="evenodd"
        d="M2.25 5.25a3 3 0 013-3h13.5a3 3 0 013 3V15a3 3 0 01-3 3h-13.5a3 3 0 01-3-3V5.25zm18 0a1.5 1.5 0 00-1.5-1.5h-13.5a1.5 1.5 0 00-1.5 1.5V15a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5V5.25z"
        clipRule="evenodd"
      />
      <path d="M1.5 19.5a1.5 1.5 0 011.5-1.5h18a1.5 1.5 0 010 3h-18a1.5 1.5 0 01-1.5-1.5z" />
    </svg>
  );
}

export function MobileIcon({ ...props }: ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      <path
        fillRule="evenodd"
        d="M8 2a3 3 0 00-3 3v14a3 3 0 003 3h8a3 3 0 003-3V5a3 3 0 00-3-3H8zm4 17.5a1 1 0 100-2 1 1 0 000 2zm2.5-16.25h-5a.75.75 0 00-.75.75v.5c0 .414.336.75.75.75h5a.75.75 0 00.75-.75v-.5a.75.75 0 00-.75-.75z"
        clipRule="evenodd"
      />
      <path
        fillRule="evenodd"
        d="M7 7a1 1 0 011-1h8a1 1 0 011 1v10a1 1 0 01-1 1H8a1 1 0 01-1-1V7zm2 1a.5.5 0 00-.5.5v7a.5.5 0 00.5.5h6a.5.5 0 00.5-.5v-7a.5.5 0 00-.5-.5H9z"
        clipRule="evenodd"
      />
    </svg>
  );
...
export function BrowserIcon({ ...props }: ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      <path
        fillRule="evenodd"
        d="M2 5a3 3 0 013-3h14a3 3 0 013 3v14a3 3 0 01-3 3H5a3 3 0 01-3-3V5zm3-1a1 1 0 00-1 1v2h16V5a1 1 0 00-1-1H5z"
        clipRule="evenodd"
      />
      <path
        fillRule="evenodd"
        d="M4 8v11a1 1 0 001 1h14a1 1 0 001-1V8H4zm3-1.5a1 1 0 11-2 0 1 1 0 012 0zm2.5 0a1 1 0 11-2 0 1 1 0 012 0zm2.5 0a1 1 0 11-2 0 1 1 0 012 0z"
        clipRule="evenodd"
      />
    </svg>
  );
